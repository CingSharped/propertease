...
class Transaction:
    def __init__(self, property_id, property_owner_id, month, money, transaction_type, workorder_id):
      self.money = money
      self.month = month
    ...
    def create_transaction(self):
      try:
        ...
        transaction_from_db = db.find_one({ 'workorder_id': self.workorder_id })
